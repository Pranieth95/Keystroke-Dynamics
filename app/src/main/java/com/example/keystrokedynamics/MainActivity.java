                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        if(password.getText().toString().length()==6) {
                            ...
                            if (password.getText().toString().equals(retype_password.getText().toString())) {
                                ...
                                mydbhelper.close();
                                Toast.makeText(MainActivity.this, "Code set successfully", Toast.LENGTH_SHORT).show();

                            } else {
                                Toast.makeText(MainActivity.this, "Codes do not match. Please try again", Toast.LENGTH_SHORT).show();
                                setPassword();

                            }
                        }else{
                            Toast.makeText(MainActivity.this, "Code Length should be 6 Characters only.", Toast.LENGTH_SHORT).show();
                            setPassword();
                            }
                    }
                });
