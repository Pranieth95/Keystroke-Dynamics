...
//                        .url("https://api.thingspeak.com/update?api_key=7QZUVRZXV3BUWPBB&field1=6")
//                        .build();
                Thread thread = new Thread(new Runnable(){
                    ...
                    public void run() {
                        try {
                            OkHttpClient client = new OkHttpClient();
                            Request request = new Request.Builder()
                                    .url("https://api.thingspeak.com/update?api_key=7QZUVRZXV3BUWPBB&field1=1")
                                    .build();
                ...
                Thread thread = new Thread(new Runnable(){
                    ...
                    public void run() {
                        try {
                            OkHttpClient client = new OkHttpClient();
                            Request request = new Request.Builder()
                                    .url("https://api.thingspeak.com/update?api_key=7QZUVRZXV3BUWPBB&field1=0")
                                    .build();
                            client.newCall(request).execute();
                        } catch (Exception e) {
                            e.printStackTrace();
